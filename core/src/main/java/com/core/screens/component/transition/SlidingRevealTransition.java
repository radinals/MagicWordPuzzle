package com.core.screens.component.transition;
...
public class SlidingRevealTransition implements Screen {
    ...
    public SlidingRevealTransition(Main main, Screen oldScreen, Screen newScreen, float duration, SlideOutTransition.SlideDirection direction) {
    ...
    public void render(float delta) {
        ...
        main.getBatch().draw(newScreenTexture, 0, 0,
